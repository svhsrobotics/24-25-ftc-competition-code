...
public class GavinsVersionOfLiamsStuff extends LinearOpMode{
...
//todo: push to robot
        ...
        while (opModeIsActive()) {
            ...
            right.setPower(reverse*(gamepad1.right_stick_x + gamepad1.left_stick_y));
            left.setPower(reverse*(gamepad1.right_stick_x - gamepad1.left_stick_y));
