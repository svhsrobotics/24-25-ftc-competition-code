...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -0.3171077044726779; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 0.31442363480328966; // x position of the perpendicular encoder (in tick units)
    }
